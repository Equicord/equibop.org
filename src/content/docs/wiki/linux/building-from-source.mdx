...
description: Learn how to build Equibop from source for development purposes.
sidebar:
    order: 3
---

:::note
To use **user plugins**, you need to build **Equicord** from source — Equibop itself does not need to be built. **You are in the wrong place.**<br></br>
